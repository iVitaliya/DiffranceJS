...
class DiffranceJS
{
    private:
        ...
        void ExecuteScriptAndWaitForEvents(char *filename)
        {
            ...
            v8::Context::Scope context_scope(this->context);
            {
                ...
                {
                    fprintf(stderr, "[INVALID_FILE] An error has occurred while trying to read a file\n");
                ...
                v8::Local<v8::Script> script = v8::Script::Compile(
                    this->context, source, &origin).ToLocalChecked();
    ...
    public:
        ...
        void InitialiseProgram(char *filename)
        {
            ...
            global->Set(isolate, "execImmediate", v8::FunctionTemplate::New(isolate, timer.SetImmediate));

            global->Set(isolate, "execThread", v8::FunctionTemplate::New(isolate, MyThread::Thread));
